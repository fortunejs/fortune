...
export default class Adapter {
  ...
  /**
   * Create a document(s). Success returns the newly created documents.
   *
   * @param {String} type
  ...
  /**
   * Update a document. Success returns the entire updated document.
   *
   * @param {String} type
   * @param {String} id
   * @param {Object} update
  ...
  /**
   * Delete a document. Success does not return any value.
   *
   * @param {String} type
   * @param {String} id
   * @return {Promise}
