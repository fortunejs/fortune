  ...
  update (type, updates) {
    ...
    return new Promise((resolve, reject) => {
      for (let update of updates) {
        const getRequest = objectStore.get(update[keys.primary])
