...
export default class Adapter {
  ...
  /**
   * The constructor method should not be implemented by the user.
   */
  constructor (context) {
  ...
  /**
   * The responsibility of the `init` method is to ensure that the resources
   ...
   * in the same order of the `entities` array. Created entities must have
   * the corresponding primary key for its type.
   *
   * @param {String} type
  ...
  /**
   * Update entities. Success does not need to return any value.
