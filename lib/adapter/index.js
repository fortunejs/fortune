...
export default class Adapter {
   ...
   *   // enforcement. Use at your own risk.
   *   operate: { ... }
   * }
   * ```
   *
   * Note that order of operations is not guaranteed. For example, the result
   * of setting and unsetting the same field may not be expected.
   *
   * @param {String} type
   * @param {Array} updates
   * @return {Promise}
