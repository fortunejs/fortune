...
export default class Core {
   ...
   *   primaryKey: 'id',
   *
   *   // A function that accepts one parameter, `type`, and returns a
   *   // string or buffer that is unique to that type. If this is not
   *   // specified, then ID generation will be left to the adapter.
   *   // Default: undefined
