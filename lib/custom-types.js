...
exports.mapCustomTypes = function(schema, types){
  ...
  function isEmbeddedArray(schema, key){
    return typeof schema[key] === 'object' && //It's an embedded schema
  ...
  function isEmbeddedSchema(schema, key){
    return typeof schema[key] === 'object' && //It is an embedded schema (guards against _.isObject(String) === true)
      _.isObject(schema[key]) && //And is not null or some other typeof quirk
