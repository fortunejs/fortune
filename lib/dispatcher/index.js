  ...
  request (options, ...args) {
    ...
    return new Promise(resolve => resolve(
      ...
      .catch(error => {
        ...
        return Promise.reject(typeof error === 'object' ?
          Object.assign(error, context.response) : context.response);
      });
  }
...
// Assign methods to the dispatcher as non-enumerable properties.
Object.defineProperties(Dispatcher.prototype,
  Object.keys(methods).reduce((properties, method) => {
    properties[method] = {
