...
const defaultFlows = {
  create: ['doCreate', 'fetchInclude', 'processResponse'],
  find: ['showIndex', 'fetchPrimary', 'fetchInclude', 'processResponse'],
  update: ['doUpdate', 'fetchInclude', 'processResponse'],
  delete: ['doDelete', 'processResponse']
};
