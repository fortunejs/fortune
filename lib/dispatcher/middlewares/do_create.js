...
export default function (context) {
  ...
  if (isRelated) {
    ...
    if (arrayProxy.find(entities, entity => inverseField in entity))
  ...
  return Promise.all(entities.map(entity => {
    ...
    if (arrayProxy.find(createdEntities, entity => !(primaryKey in entity)))
