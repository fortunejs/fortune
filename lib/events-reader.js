    ...
    function tail() {
        ...
        return fortuneApp.adapter.find('checkpoint', {})
            .then(function (checkpoint) {
                ...
                console.log('checkpoint ts : ' + new Date(checkpoint.ts.getHighBits() * 1000));
                        ...
                        oplog
                            ...
                            .on('op', function (doc) {
                                ...
                                new RSVP.Promise(function (resolve, reject) {
                                    ...
                                    .then(function () {
                                        console.log('update checkpoint with ts ' + doc.ts.getHighBits() + ' ' + doc.ts.getLowBits());
