    ...
    return function (oplogMongodbUri, skip, success) {
            ...
            if (doc != null) {
                ...
                _.forEach(matchedChangeHandlers, function (changeHandler) {
                        ...
                        if (!asyncInMemory) {
                            ...
                            processWithHandler(that, changeHandler, doc, dfd);
                        } else {
                            _.delay(processWithHandler, 0, that, changeHandler, doc, null);
                        }
        ...
        function executeHandler(that, id, dfd, opFn, changeHandler, changeHandlerOp, doc) {
            ...
            new RSVP.Promise(function (resolve, reject) {
                ...
                .catch(function (err) {
                    ...
                    _.delay(processWithHandler, 500, that, changeHandler, doc, dfd);
                });
        }
        ...
        docStream.map(function (doc) {
            ...
            _.forEach(matched, function (changeHandler) {
                processWithHandler(null, changeHandler, doc, null);
            });
        }).parallel(100);
