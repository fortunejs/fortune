                    ...
                    _.forEach(changeHandlers, function (changeHandler) {
                        ...
                        oplog
                            ...
                            .on('op', function (doc) {
                                 ...
                                 * when there are multiple changeHandlers for the same resource
                                 * or some events have exactly the same timestamp
                                 * there is a risk that a checkpoint is created with still unhandled events outstanding
                                 * which have the same ts
                                 *
                                 * */
