...
Fortune.prototype._init = function (options) {
  ...
  router.get("/metadata", function(req,res){
    res.write(JSON.stringify({metadata: _.reduce(_this.metadata, function(memo, md, name){
      ...
      memo[name] = _.extend({}, md, {schema: schema});
      return memo;
    }, {})}));
    res.end();
  }); 
...
Fortune.prototype.resource = function(name, schema, options) {
  ...
  this.metadata[name] = { schema: schema, modelOptions: modelOptions };
