 ...
 * ```js
 * {
 *   adapter: 'nedb', // May be string or object. Default: 'nedb'
 *   serializer: ['json-api'], // An array containing strings or objects. Default: 'json-api'
 *   prefix: '', // Prefix for hyperlink URIs. Useful for absolute paths, or if its mounted under a path. Default: ''
 *   inflect: true // Whether to automatically inflect strings in the serializer and router. Default: true
 * }
 * ```
 *
