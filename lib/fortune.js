 ...
 * The callback function has one parameter, the request object.
 ...
 *
 * ```javascript
 * app.before('resource', function(request) {
 ...
 * @param {Function} fn this callback function is called within the context of the resource, and has one parameter: the request object.
 * @return {this}
 */
