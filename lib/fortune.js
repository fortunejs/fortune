 ...
 */
Fortune.prototype.onRouteCreated=function(name){
  var deferred = RSVP.defer();
  routeCreatedDeferred[name]=deferred;
  if (createdRoutes[name]) {
    deferred.resolve(createdRoutes[name].fnHandlers);
  }
...
Fortune.prototype.resource = function (name, schema, options) {
  ...
  this.adapter.awaitConnection().then(function () {
    ...
    routeCreatedDeferred[name] && routeCreatedDeferred[name].resolve(createdRoutes[name].fnHandlers);
  }).catch(function(err) {
    routeCreatedDeferred[name] && routeCreatedDeferred[name].reject(err);
  });
  return this;
