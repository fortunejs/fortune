...
Fortune.prototype.find = function () {
  ...
  if (1 in arguments) options.ids = Array.isArray(arguments[1]) ?
    arguments[1] : [ arguments[1] ]
  if (2 in arguments) options.options = arguments[2]
  if (3 in arguments) options.include = arguments[3]
  if (4 in arguments) options.meta = arguments[4]
...
Fortune.prototype.create = function () {
  ...
  if (2 in arguments) options.include = arguments[2]
  if (3 in arguments) options.meta = arguments[3]
