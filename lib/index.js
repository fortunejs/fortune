...
export default class Fortune {
   ...
   * ```js
   * {
   *   // The method is a Symbol type, keyed under `dispatcher.events` and may
   *   // be one of `find`, `create`, `update`, or `delete`. To implement a
   *   // custom method, define a new method under `dispatcher.methods`, and
   ...
   * ```
   *
   * The response object should always be typed.
   *
   * @param {Object} options
   * @param {...*} [args]
   * @return {Promise}
