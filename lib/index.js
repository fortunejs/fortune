...
export default class Fortune {
  ...
  constructor (options) {
    Object.defineProperties(this, {
      ...
      _initializationStatus: { writable: true, value: 0 },

      _current: { writable: true, value: undefined },
   ...
   * The reason that this exists is because of model definition happening
   * after instantiation, so this needs to be called manually when
   * models are defined, and also because establishing a database connection
   * may take time.
   *
   * @return {Promise}
   */
