...
export default class Fortune {
  ...
  constructor (options) {
    ...
    // The singletons are responsible for dependency injection.
   ...
   * object and a single `entity`. The before transform may take an additional
   ...
   * argument `entity` either synchronously, or asynchronously as a Promise.
   ...
   *
   * An example transform to apply a timestamp on a entity before writing,
