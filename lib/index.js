...
export default class Fortune {
  ...
  /**
   * Define a record type given a name and a set of field definitions.
   * The base `fields` object only serves to enforce data types, and may be
   * extended by the specific `Adapter` to do more, such as validation. Here
   * are some example field definitions of the `fields` object:
   *
   * ```js
   * {
   *   // A singular value.
   ...
   * @param {Object} fields - A hash of field definitions.
   * @return {this}
   */
