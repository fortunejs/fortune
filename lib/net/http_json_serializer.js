...
module.exports = function (HttpSerializer) {
  ...
  function (contextRequest, request, response) {
    ...
    var parameter, field, fieldType, value, error
    ...
    contextRequest.method = methodMap[request.method]
    ...
    if (contextRequest.method === methods.find &&
      ...
      error = new Error('No type or IDs specified, showing index.')
      error.payload = {
