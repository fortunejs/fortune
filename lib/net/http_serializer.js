...
/**
 * `HttpSerializer` is an abstract base class containing methods to be
 * implemented. Generally, all of its methods should be implemented, unless
 * it's an input-only serializer.
 */
...
/**
 * This gets run first. The purpose is typically to read and mutate the request
 ...
 */
HttpSerializer.prototype.processRequest = function (contextRequest) {
