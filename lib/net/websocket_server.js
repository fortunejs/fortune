 ...
 * the user. There is an option, `useIPC`, which may be set to `false` to
 * disable the IPC functionality.
 *
...
function ws (instance, change, options, callback) {
  ...
  if (!options) options = {}
  if (!('useIPC' in options)) options.useIPC = true
  ...
  server.on('connection', function (socket) {
    ...
    if (isWorker && useIPC)
      process.on('message', function (message) {
        ...
        Object.defineProperty(changes, 'ipc', { value: true })
