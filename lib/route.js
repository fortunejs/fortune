...
function route(name, model, resources, inflect, querytree) {
  var _this = this
    ...
    , actionRoute = namespace + '/' + collection + '/:id' + '/action' + '/:action' + suffix
  ;
  ...
  function getResource(req, res) {
    console.log("get individual route");
    var match = {};
   ...
   */
  router.get(actionRoute, getResourceAction);

  function getResourceAction(req, res) {
    ...
    actionModule.handleAction(params);
  }
