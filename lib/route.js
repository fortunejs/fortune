      ...
      req.body.forEach(function (operation) {
        ...
        if (operation.op === 'replace') {
          ...
          if (field.length > 1 && field[0] !== "links") {
            ...
            console.log('updating links ', field[field.length - 2]);
            path[pushKey][field[field.length - 2]] = path[pushKey][field[field.length - 2]] || [];
            path[pushKey][field[field.length - 2]].push(value);
          }
        }else if (operation.op === 'remove'){
          var pullKey = '$pullAll';
          console.log('before pop', field);
          value = field.pop();
          ...
          if (field.length > 1 && field[0] !== "links") {
            ...
            console.log('updating links ', field[field.length - 1], value);
