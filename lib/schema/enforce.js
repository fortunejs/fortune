...
const inputMap = new WeakMap([
  [String, value => typeof value === 'string' ? value : value.toString()],
  [Number, value => typeof value === 'number' ? value : parseInt(value, 10)],
  [Boolean, value => typeof value === 'boolean' ? value : !!value],
  [Date, value => value instanceof Date ? value : new Date(value)],
  [Object, value => value instanceof Object ?
    value : {}],
  [Buffer, value => Buffer.isBuffer(value) ? value : new Buffer(value)]
]);
