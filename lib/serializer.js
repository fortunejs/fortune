...
function proxyInput(context) {
  return this.types[context.request.serializerInput]
    [method](...arguments);
}

function proxyOutput(context) {
  return this.types[context.request.serializerOutput]
    [method](...arguments);
}
