...
export default class Serializer {
  ...
  /**
   * Render entities in the response. The parameter `entities` is an array
   * of entities. The parameter `include` is a hash that must follow this
   * format:
   *
   * ```js
   * {
   *   // An object keyed by type, valued by arrays of entities.
   *   [type]: [ ... ]
   * }
   * ```
   *
