...
xdescribe('Fortune neo4j test runner', function(){
  var options = {
    app: null,
    port: port,
    ioPort: ioPort,
  ...
  //TODO : This should be refactored to support testing multiple DBs
  ...
  require('./fortune-mongodb/neo4j.spec.js')(options);
